...
OUT_DIR=/work/data/wrfout/validation_20241001_00_72h
NAMELIST=/work/wrf/namelists/namelist.input.72h.template
NPROC=${NPROC:-1}
...
test -f wrfout_d01_2024-10-04_00:00:00
...
test -f "$OUT_DIR/wrfout_d01_2024-10-04_00-00-00"

echo "WRF 72h validation complete with NPROC=$NPROC: $OUT_DIR"

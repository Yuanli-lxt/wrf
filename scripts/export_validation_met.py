...
SOURCE_DIR = Path("data/wrfout/validation_20241001_00")
ASCII_DIR = Path("data/generated/wrfout_validation_ascii")
OUTPUT_PATH = Path("data/generated/apsim/validation_wrf_20241001.met")
